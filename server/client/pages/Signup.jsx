...
const Signup = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center flex-col lg:flex-row bg-gradient-to-b from-[#cacbcd] to-[#323841]">
      <div className="md:w-auto flex gap-0 lg:gap-40 flex-col lg:flex-row items-center justify-center">
        {/* left side */}
        ...
        <div className="md:1/3 p-4 md:p-1 flex flex-col justify-center items-center">
          <form
            ...
            className="form-container w-full md:w-[400px] flex flex-col gap-y-7 bg-[#f8f8f8] p-6 lg:px-10 lg:py-12"
          >
            <div>
